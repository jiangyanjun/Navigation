var defaultEncoding = 1; // îAÔOÕZÑÔ£º1-·±ówÖÐÎÄ | 2-¼òÌåÖÐÎÄ
var translateDelay = 0;
var cookieDomain = "http://yoursite";		// ÐÞ¸Ä ‘ÄãµÄ²¿Âä¸ñµØÖ·
var msgToTraditionalChinese = "ÞD“Q ‘·±ów";	// º†ÞD·±•rËùï@Ê¾µÄÎÄ×Ö
var msgToSimplifiedChinese = "×ª»»Îª¼òÌå"; 	// ·±×ª¼òÊ±ËùÏÔÊ¾µÄÎÄ×Ö
var translateButtonId = "translateLink";	// ¡¸ÞD“Q¡¹<A>æœ½Ó˜Ë»`ID
